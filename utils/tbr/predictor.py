            ...
            for batch in self.dataset:
                ...
                with profilers[1]:
                    ...
                    if self.args.embed:
                        ...
                        continue
                    # SAM-CD: when model returns multi-scale features as 3rd element, yield them and skip postprocess
                    if isinstance(preds, (tuple, list)) and len(preds) == 3 and isinstance(preds[2], list):
                        yield from preds[2]  # yield each feature tensor individually
                        continue
